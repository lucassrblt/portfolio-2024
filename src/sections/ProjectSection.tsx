...
const ProjectSection = () => {
    return (
    <section className="flex flex-col gap-[100px] w-screen px-[130px]">
    ...
    return (
        <div className="flex flex-col w-full items-center justify-center gap-[150px] ">
            {projects.map((project, index) => (
                <Card key={index} title={project.title} paragraphs={project.paragraphs} img={project.img} tags={project.tags} links={project.links}/>
            ))}
        </div>
    )
}